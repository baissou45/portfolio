    ...
    <div class="nicescroll-bar">
        <div class="drawer-profile-wrap">
            ...
            <ul class="social-icons  mb-30">
                ...
                <li>
                    <a class="dribbble-whatsapp" href="https://s4w.in/46IQg">
                        <i id="tt14" class="zmdi zmdi-whatsapp"></i>
        ...
        <div class="drawer-footer mt-50 mb-30 text-center">
            <p class="font-12 mt-10">Hencework &copy; {{  now()->year }}.</p>
        </div>
    </div>
</div>
